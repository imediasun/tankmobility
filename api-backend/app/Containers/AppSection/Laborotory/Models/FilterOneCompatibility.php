...
/**
 * @OA\Schema(
 *     title="FilterOneCompatibility",
 *     description="FilterOneCompatibility model",
 * )
 */

class FilterOneCompatibility extends ParentModel
{
    protected $fillable = [
     ...
     */
    protected string $resourceKey = 'FilterOneCompatibility';

    public $table = 'test_compatibility_filter_one';

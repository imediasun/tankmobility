...
use App\Containers\AppSection\Authentication\Tasks\CreateUserByCredentialsInLDAPTask;
...
class RegisterUserAction extends ParentAction
{
    ...
    public function run(RegisterUserRequest $request): User
    {
        ...
        $ldap = app(CreateUserByCredentialsInLDAPTask::class)->run($user,$sanitizedData);
